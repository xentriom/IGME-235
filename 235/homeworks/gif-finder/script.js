...
function searchButtonClicked() {
    ...
    // 8 - append the search term to the URL - the parameter name is 'q url += "&q=" + term;
    url += "&q=" + term;
...
function dataLoaded(e) {
    // 5 - event.target is the hr object
    let xhr = e.target;
    ...
    for (let i = 0; i < results.length; i++) {
        ...
        // 15 - add the ‹div> to 'bigString' and loop bigString += line;
        bigString += line;
    }
